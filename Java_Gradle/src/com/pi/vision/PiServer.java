...
public class PiServer extends Thread{
	...
	private final String ip = "10.45.43.101";
	private final int port = 27;//randomly using port 27 might be bad idea

	public static void main(String[] args) throws IOException, ClassNotFoundException {
		System.out.println("Searching for native, if there is an unlinked expection add the native to one of these paths");
...
//		System.out.println(serializedData);
	...
	public void run() {
		...
		try {
			System.out.println("Looking for connection on " + ip + ", port " + port);
			connection = new PiConnection(ip, port); 
