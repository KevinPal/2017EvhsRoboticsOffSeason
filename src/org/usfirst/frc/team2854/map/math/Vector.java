...
public class Vector {
	 ...
	 * 
	 * @param r
	 *            the double to add to the Vector
	 ...
	 * @param v
	 *            the Vector to add
	 * @return a new Vector that has components incremented by Vector v's respective
	 *         components
	 */
	 ...
	 * @param v2
	 *            the other Vector to be dotted with
	 * @return the dot product of this and Vector v
	 */
	...
	/**
	 * @Precondition matrix has 4 rows, 4 columns or more. Multiplies this Vector by
	 *               a Matrix m
	 * @param m
	 ...
	 * 
	 * @param r
	 *            the multiplication Vector to multiply this Vector by
	 * @return a new Vector with multiplied components
	 */
	 ...
	 * 
	 * @param r
	 *            the double to subtract from this Vector
